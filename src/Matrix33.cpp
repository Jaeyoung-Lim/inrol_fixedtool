...
Matrix33::Matrix33(void): r1(1,0,0), r2(0,1,0), r3(0,0,1)
{
	...
	// create Matrix with all zero vectors
}

Matrix33::Matrix33(double (&vec)[9]): r1(vec[0],vec[1],vec[2]), r2(vec[3],vec[4],vec[5]), r3(vec[6],vec[7],vec[8])
{
	// constructor with three vectors (array with 9 elements)
	// create Vector Object with r1, r2, r3
}
...
Matrix33 Matrix33::operator/(double iDouble) const
{
	// function for division with const
	Matrix33 oM;
	oM.r1 = r1/iDouble;
	oM.r2 = r2/iDouble;
	oM.r3 = r3/iDouble;
...
Matrix33 Matrix33::operator*(Matrix33 iM) const
{
	// function for multiplication with another 3x3 matrix
	Matrix33 oM;
	double Array[9];
	Array[0] = r1.x;
	Array[1] = r1.y;
...
double & Matrix33::operator[](int pos)
{
